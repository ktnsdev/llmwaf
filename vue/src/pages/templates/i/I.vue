...
<template>
    <div id="container" class="container">
        <div class="terms-container">
            ...
            <br />
            1.2. These Terms of Use govern your use of [Company Name]'s website, services, and any
            related applications (collectively referred to as the "Service").
            <br />
            ...
            <br />
            2.3. "Content" refers to text, images, videos, audio, or any other materials available
            on the Service.
            <br />
            3. Acceptable Use
            <br />
            3.1. You agree to use the Service only for lawful purposes and in accordance with these
            Terms of Use.
            <br />
            ...
            <br />
            4.2. You may not use, modify, reproduce, distribute, or exploit any Content without the
            ...
            <br />
            7.1. In no event shall [Company Name] be liable for any indirect, incidental, special,
            consequential, or punitive damages, arising out of or in connection with your use of the
            Service.
            <br />
            8. Governing Law
            <br />
            8.1. These Terms of Use shall be governed by and construed in accordance with the laws
            ...
            time. Your continued use of the Service after any changes indicates your acceptance of
            the revised terms.
            <br />
            10. Contact Us
            <br />
            10.1. If you have any questions or concerns about these Terms of Use, please contact us
            at [contact email].
            <br />
        </div>
